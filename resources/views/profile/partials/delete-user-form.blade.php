<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta cancellato il profilo non i dati verranno perduti per sempre, assicurati prima di salvare i dati che servono.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Sei sicuro di cancellare il profilo?') }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta cancellato il profilo non i dati verranno perduti per sempre. Per favore inserisci la passord per cancellare per sempre i dati.') }}
                    </p>
                </div>
