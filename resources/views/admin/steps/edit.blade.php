        ...
        <form action="{{ route('admin.steps.update', $step) }}" method="post" enctype="multipart/form-data">
                ...
                <select class="form-select form-select-lg @error('travel_id') is-invalid @enderror" name="travel_id"
                    ...
                    @foreach ($travels as $travel)
                        <option value="{{ $travel->id }}"
                            {{ $travel->id === old('travel_id', $step->travel_id) ? 'selected' : '' }}>
                            {{ $travel->name }}</option>
                    @endforeach
                </select>
                {{-- errore lato back --}}
            ...
            <div class="mb-3">
                ...
                <input onkeyup="hide_date_error()" onblur="check_date()" type="date"
                    ...
                    aria-describedby="dateHelper" value="{{ old('date', $step->date) }}" placeholder="" required />
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control @error('image') is-invalid @enderror" name="image"
                    id="image" value="{{ old('image', $step->image) }}" placeholder=""
